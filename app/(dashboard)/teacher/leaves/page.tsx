  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold">我的请假</h1>
          <p className="text-muted-foreground">管理学生请假申请</p>
        </div>
      ...
      <div className="flex gap-4 flex-wrap">
        ...
        <Select value={semesterFilter || "all"} onValueChange={(v) => setSemesterFilter(v === "all" ? "" : v)}>
